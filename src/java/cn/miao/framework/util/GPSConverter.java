...
import cn.miao.framework.entity.GPSPoint;
...
//		int casm_c = 453806245;
	...
	protected GPSPoint wgtochina_lb(int wg_flag, int wg_lng, int wg_lat,
		...
		y_add = y_add + h_add * 0.001
				+ me.yj_sin2(wg_time * 0.0174532925199433) + me.random_yj();
		point = new GPSPoint();
		point.setLng(((x_l + me.Transform_jy5(y_l, x_add)) * 3686400));
		point.setLat(((y_l + me.Transform_jyj5(y_l, y_add)) * 3686400));
		return point;
	}
	...
	public GPSPoint getEncryPoint(double x, double y) {
	...
	public static void main(String argv[]) throws Exception {
		...
		GPSPoint p = c.getEncryPoint(102.702825064591, 25.0457617282833);
