define(['text!./password.html'],function(tpl){
	return {
		template:tpl,
		data:function(){
			var vm = this;
		...
		methods:{
			submitForm:function(formName){
				...
				vm.$refs[formName].validate((valid) =>{
					$.getJSON(SYSCONFIG.apiurl('updateAppPassword!resource'),{oldpassword:this.ruleForm2.old,newpassword:this.ruleForm2.pass})
					.then(function(json){
						vm.list = json;
